...
from aistats.oracle.forclift_callers import ForcliftClientCaller
...
class HeuristicSolver:
    ...
    def solve(self, relaxation: float = 0.0):
        ...
        print(ord_lims)
        for cut in itertools.product(*[range(0, v[1] + 1, max(1, math.floor(relaxation * v[0]))) for v in ord_lims[:-1]]):
